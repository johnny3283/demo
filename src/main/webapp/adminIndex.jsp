            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="<%=request.getContextPath()%>/manager/addManager.jsp">新增員工aaaaaaaa</a>

                        </li>
                        <li>
                            <a class="dropdown-item" href="<%=request.getContextPath()%>/manager/listAllManager.jsp">員工查詢</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/latest_news/listAllLatest_news.jsp">最新消息列表</a>
                                </li>
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/latest_news/select_page.jsp">最新消息查詢</a>
                                </li>
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/latest_news/InsertLatest_news.jsp">最新消息新增</a>
                                </li>
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/latest_news/InsertLatest_news.jsp">最新消息修改</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="dropdown-item">康健新知論壇管理&emsp;></a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/forum_article/forum_article_select_page.jsp">康健新知論壇列表</a>
                                </li>
                                <li><a class="dropdown-item"
                                       href="<%= request.getContextPath() %>/forum_article/listAllForum_article.jsp">康健新知論壇文章列表</a>
                                </li>
                                <li><a class="dropdown-item"
                                       href="<%= request.getContextPath() %>/forum_comment/listAllForum_comment.jsp">康健新知論壇留言列表</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="dropdown-item">FAQ管理&emsp;></a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/faqservlet?action=getAll">FAQ列表</a></li>
                                <li><a class="dropdown-item"
                                       href="<%=request.getContextPath()%>/faq/addFAQ.jsp">新增FAQ</a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item"
                               href="${ctxPath}/meal/mealController?action=listAll">菜單商品列表</a>
                        </li>
                        <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="${ctxPath}/phyCouPromotion/addPro.jsp">新增實體課程促銷專案</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                               href="${ctxPath}/phyCouPromotion/select_page.jsp">查詢修改實體課程促銷專案</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                               href="${ctxPath}/phyCouSignUpMgn/listAllSignUpCou.jsp">實體課程報名管理</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item"
                               href="${pageContext.request.contextPath}/onlineCourseOrderServlet?action=orderlist">線上課程訂單管理</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                ...
                <c:if test="${not empty manager}">
                    <li class="nav-item">
                        ...
                        &emsp;
                        <button id="outbutton">
                            <a href="./manager/ManagerServlet?action=Logout"
                               style="display:inline-block; text-decoration:none;color:black;">登出</a>
                        </button>
                    </li>
                </c:if>
